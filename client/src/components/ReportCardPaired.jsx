    ...
    >
      <div className="flex w-full h-40">
        <div className="w-1/2 relative">
          ...
          <img src={pair.beforeReport.image} alt="Before" className="w-full h-full object-cover" />
        </div>
        <div className="w-1/2 relative border-l-2 border-surface">
          ...
          <img src={pair.afterReport.image} alt="After" className="w-full h-full object-cover" />
        </div>
      </div>
      <div className="p-4">
        <p className="text-sm text-muted-foreground mb-2">{pair.beforeReport.timestamp.toLocaleString()}</p>
